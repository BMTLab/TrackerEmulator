...
using TrackerClientEmulator.ViewModels.Pages;
using TrackerClientEmulator.Views.Pages;

using BaseThisNavigationPage = Xamarin.Forms.NavigationPage;
using ThisNavigationPage = TrackerClientEmulator.Views.NavigationPage;
